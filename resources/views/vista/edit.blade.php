                    ...
                    <div class="card-body">
                        <form action="{{route('products.update', $Editproduct->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class ="form-control" type="text" name="producto" id="producto" value="{{$Editproduct->name}}">
                                <label for="descripcion">descripción</label>
                                <input class ="form-control" type="text" name="descripcion" id="descripcion" value="{{$Editproduct->description}}">
                                <label for="valor">valor</label>
                                <input class ="form-control" type="number" name="valor" id="valor" value="{{$Editproduct->price}}">
                            </div>
                            <div class="form-group">
